...
public class Xpath_By_Axes2 {
	...
	public static void main(String[] args) throws InterruptedException {
	    ...
	    driver.findElement(By.xpath("//span[text()='Xiaomi 125 cm (50 inches) X Pro 4K Dolby Vision IQ Series Smart Google TV L50M8-5XIN (Black)']/../../../..//button[@class='a-button-text']")).click();
	    Thread.sleep(2000);
	    driver.findElement(By.xpath("//img[@class='ewc-delete-icon']")).click();
	    //Thread.sleep(2000);
	    driver.quit();
	   ...
	   // driver.findElement(By.xpath("//button[@id='a-autoid-2-announce']")).click();
	    //driver.findElement(By.xpath("(//a[@class='a-size-mini a-link-normal s-underline-text s-underline-link-text s-link-style'])[1]")).click();
	    driver.quit();
	   // Thread.sleep(2000);
